...
static inline double* v3_add(v3 x, v3 y, v3 z)
{
    v3 c;
    c[0] = x[0] + y[0];
    c[1] = x[1] + y[1];
...
static inline double*  v3_subtract(v3 x, v3 y)
{
    double c[3];
    c[0] = x[0] - y[0];
    c[1] = x[1] - y[1];
...
static inline double* v3_scale(v3 x, double s, v3 z)
{    v3 c;
...
static inline double* v3_cross(v3 a, v3 b, v3 c)
{
